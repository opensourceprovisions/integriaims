...
// Version the plugin by Miguel de Dios Matias.
...
class Upload
{
	...
	<div id="upload-form">
	  <form method="post" action="'.$self_form.'&action=' . $action . '" enctype= "multipart/form-data">
	...
	function template()
	{
		...
		//if($action == "edit" || $preview) {
			$html = template_replace("plugin:UPLOAD", "<a href=\"$self" . "action=upload\" rel=\"nofollow\">Upload File</a>", $html);
		//}
	}
