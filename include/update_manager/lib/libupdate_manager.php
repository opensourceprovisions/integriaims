...
function um_db_connect ($backend = 'mysql', $host = '', $user = '', $password = '', $db_name = '') {
	//The sourcecode in Pandora
	//return db_connect ($host, $db_name, $user, $password);
	
	$return = mysql_connect($host, $user, $password);
	mysql_select_db($db_name, $return);
...
function um_component_db_connect () {
	...
	$return = mysql_connect($settings->dbhost, $settings->dbuser, $settings->dbpass);
	mysql_select_db($settings->dbname, $return);
